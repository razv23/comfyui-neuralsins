# ABOUTME: Main entry point for ComfyUI NeuralSins custom nodes
...
for file in files:
    ...
    try:
        ...
        print(f"[comfyui-neuralsins] Failed to load {file}: {e}")

WEB_DIRECTORY = "./web"

__all__ = ["NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS", "WEB_DIRECTORY"]

print(f"\033[34mNeuralSins Nodes: \033[92mLoaded {len(NODE_CLASS_MAPPINGS)} nodes\033[0m")
